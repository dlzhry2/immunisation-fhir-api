...
class DeltaTestCase(unittest.TestCase):
    ...
    def test_send_message_client_error(self, mock_logger_info, mock_boto_client):
        ...
        # Assert
        mock_logger_info.assert_called_once_with(f"Error sending record to DLQ: An error occurred (500) when calling the SendMessage operation: Internal Server Error")
