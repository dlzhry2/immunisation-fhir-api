...
class UKFHIRImmunization():
    ...
    def get_actor(self):
        return {"actor": json.loads(self.actor.json())}  #Matching representation to that of Expected JSON
    ...
    def get_reason_code(self):
        ...
        reason_code_json_list = [json.loads(reason_code.json()) for reason_code in self.reasonCode]
