...
from fhir.resources.immunization import ImmunizationProtocolApplied as FHIRImmunizationProtocolApplied
...
def convert_to_fhir(immunization_model):
    ...
    fhir_patient=FHIRPatient(identifier=[FHIRIdentifier(
    ...
    fhir_patient.name= [FHIRHumanName(
    ...
    fhir_patient.address=[
                FHIRAddress(
                        postalCode=immunization_model.PERSON_POSTCODE
                    )]
    ...
    vaccine_codeable_concept = FHIRCodeableConcept(
        coding=[vaccine_code_coding]
    )
    ...
    item=[  QuestionnaireResponseItem(linkId="SiteCode", 
            ...
            QuestionnaireResponseItem(linkId="SiteName", 
                           answer=[ QuestionnaireResponseItemAnswer(
                               valueCoding=FHIRCoding(
                        code=immunization_model.SITE_NAME
                    )
                           ) ]
                            ),
            QuestionnaireResponseItem(linkId="NhsNumberStatus", 
                           answer=[ QuestionnaireResponseItemAnswer(
                               valueCoding=FHIRCoding(
            ...
            QuestionnaireResponseItem(linkId="LocalPatient", 
                           answer=[ QuestionnaireResponseItemAnswer(
                               valueCoding=FHIRCoding(
            ...
            QuestionnaireResponseItem(linkId="CareSetting", 
                           answer=[ QuestionnaireResponseItemAnswer(
                               valueCoding=FHIRCoding(
            ...
            QuestionnaireResponseItem(linkId="IpAddress", 
                           answer=[ QuestionnaireResponseItemAnswer(
                               valueCoding=FHIRCoding(
                        code=immunization_model.IP_ADDRESS
                    )
                           ) ]
                            ),
            QuestionnaireResponseItem(linkId="UserId", 
                           answer=[ QuestionnaireResponseItemAnswer(
                               valueCoding=FHIRCoding(
                         code=immunization_model.USER_ID
                    )
                           ) ]
                            ),
            QuestionnaireResponseItem(linkId="UserName", 
                           answer=[ QuestionnaireResponseItemAnswer(
                               valueCoding=FHIRCoding(
                         code=immunization_model.USER_NAME
                    )
                           ) ]
                            ),
            QuestionnaireResponseItem(linkId="UserEmail", 
                           answer=[ QuestionnaireResponseItemAnswer(
                               valueCoding=FHIRCoding(
                        code=immunization_model.USER_EMAIL
                    )
                           ) ]
                            ),
            QuestionnaireResponseItem(linkId="SubmittedTimeStamp", 
                           answer=[ QuestionnaireResponseItemAnswer(
                               valueCoding=FHIRCoding(
            ...
            QuestionnaireResponseItem(linkId="ReduceValidation", 
                           answer=[ QuestionnaireResponseItemAnswer(
                               valueCoding=FHIRCoding(
    ...
    uk_fhir_immunization.immunization.identifier= [FHIRIdentifier(value=immunization_model.UNIQUE_ID, system=immunization_model.UNIQUE_ID_URI)]   
    performer_identifier = [FHIRIdentifier(
    ...
    performer_name = [FHIRHumanName(
    family=immunization_model.PERFORMING_PROFESSIONAL_SURNAME,
    given=[immunization_model.PERFORMING_PROFESSIONAL_FORENAME]
    )]
    #Not populating it directly with FHIRImmunizationPerformer becasue it is reference to practitioner but we want actual Practitioner content
    uk_fhir_immunization.actor=FHIRPractitioner(resource_type="Practitioner", identifier=performer_identifier, name=performer_name)
    ...
    uk_fhir_immunization.immunization.protocolApplied=[
                                        FHIRImmunizationProtocolApplied(targetDisease=[FHIRCodeableConcept(
                                        coding=[FHIRCoding(
                                        code=immunization_model.VACCINE_CUSTOM_LIST
                                    )])],
    ...
    uk_fhir_immunization.manufacturer=FHIROrganization(resource_type="Organization", name=immunization_model.VACCINE_MANUFACTURER)
    ...
    uk_fhir_immunization.immunization.doseQuantity=FHIRQuantity(value=immunization_model.DOSE_AMOUNT,code=immunization_model.DOSE_UNIT_CODE, unit=immunization_model.DOSE_UNIT_TERM, system="http://unitsofmeasure.org" )
    
    uk_fhir_immunization.immunization.location=FHIRReference(
                                        identifier= FHIRIdentifier(value=immunization_model.LOCATION_CODE, system=immunization_model.LOCATION_CODE_TYPE_URI) 
                                        )
    uk_fhir_immunization.recorded=immunization_model.RECORDED_DATE
    uk_fhir_immunization.reportOrigin=FHIRCodeableConcept(text=immunization_model.REPORT_ORIGIN)
    uk_fhir_immunization.reasonCode=[FHIRCodeableConcept(
        coding=
        [
            FHIRCoding(
