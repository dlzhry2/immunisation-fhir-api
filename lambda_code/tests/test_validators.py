...
class TestNHSValidationRules(unittest.TestCase):
    ...
    def test_invalid_nhs_number(self):
        ...
        with self.assertRaises(ValueError):
            NHSValidators.validate_nhs_number(invalid_nhs_number)
    ...
    def test_valid_person_forename(self):
        ...
        self.assertTrue(NHSValidators.validate_person_forename(valid_person_forename))
    ...
    def test_invalid_person_forename(self):
        ...
        for invalid_person_forename in invalid_person_forenames:
            with self.assertRaises(ValueError):
                NHSValidators.validate_person_forename(invalid_person_forename)
    ...
    def test_valid_person_surname(self):
        ...
        self.assertTrue(NHSValidators.validate_person_surname(valid_person_surname))
    ...
    def test_invalid_person_surname(self):
        ...
        for invalid_person_surname in invalid_person_surnames:
            with self.assertRaises(ValueError):
                NHSValidators.validate_person_surname(invalid_person_surname)


    def test_person_dob(self):
        """Test person_dob accepts valid person DOB"""
        valid_person_dob = "2000-01-01"
        self.assertTrue(NHSValidators.validate_person_dob(valid_person_dob))
    ...
    def test_person_gender_code(self):
        ...
        for valid_person_gender_code in valid_person_gender_codes:
            self.assertTrue(NHSValidators.validate_person_gender_code(valid_person_gender_code))
    ...
    def test_date_and_time(self):
        ...
        valid_date_and_times = ["2021-01-01", "2021-01-01T00:00:00", "2021-01-01T00:00:00+00:00"]
    ...
    def test_unique_id(self):
        ...
        unique_ids = ["e045626e-4dc5-4df3-bc35-da25263f901e",
                      "ACME-vacc123456", "ACME-CUSTOMER1-vacc123456"]
