...
class FhirService:
    ...
    def update_immunization(
        self, imms_id: str, immunization: dict, existing_resource_version: int, existing_vax_type: str
        ...
        if "diagnostics" in patient: 
                return (None,patient)
        imms = self.immunization_repo.update_immunization(imms_id, immunization, patient, existing_resource_version, existing_vax_type)
    ...
    def reinstate_immunization(
        ...
        if "diagnostics" in patient: 
                return (None,patient)
        imms = self.immunization_repo.reinstate_immunization(imms_id, immunization, patient, existing_resource_version, existing_vax_type)
        return UpdateOutcome.UPDATE, Immunization.parse_obj(imms)
    ...
    def update_reinstated_immunization(
        ...
        if "diagnostics" in patient: 
                return (None,patient)
        imms = self.immunization_repo.update_reinstated_immunization(imms_id, immunization, patient, existing_resource_version, existing_vax_type)
        return UpdateOutcome.UPDATE, Immunization.parse_obj(imms)
