...
class TestCreateImmunization(unittest.TestCase):
    ...
    def test_create_immunization(self):
        ...
        pds_patient = {'address': [{'extension': [{'extension': [{'url': 'type', 'valueCoding': {'code': 'PAF', 'system': 'https://fhir.hl7.org.uk/CodeSystem/UKCore-AddressKeyType'}}, {'url': 'value', 'valueString': '19459619'}], 'url': 'https://fhir.hl7.org.uk/StructureDefinition/Extension-UKCore-AddressKey'}], 'id': 'k5f5', 'line': ['GREENACRES', 'WOODCOCK HILL', 'RICKMANSWORTH', 'HERTS'], 'period': {'start': '2012-12-21'}, 'postalCode': 'WD3 1PT', 'use': 'home'}], 'birthDate': '2012-12-18', 'gender': 'female', 'generalPractitioner': [{'id': 'gs8c', 'identifier': {'period': {'start': '2012-12-27'}, 'system': 'https://fhir.nhs.uk/Id/ods-organization-code', 'value': 'E82045'}, 'type': 'Organization'}], 'id': '9990548609', 'identifier': [{'extension': [{'url': 'https://fhir.hl7.org.uk/StructureDefinition/Extension-UKCore-NHSNumberVerificationStatus', 'valueCodeableConcept': {'coding': [{'code': '01', 'display': 'Number present and verified', 'system': 'https://fhir.hl7.org.uk/CodeSystem/UKCore-NHSNumberVerificationStatus', 'version': '1.0.0'}]}}], 'system': 'https://fhir.nhs.uk/Id/nhs-number', 'value': '9990548609'}], 'meta': {'security': [{'code': 'U', 'display': 'unrestricted', 'system': 'http://terminology.hl7.org/CodeSystem/v3-Confidentiality'}], 'versionId': '4'}, 'multipleBirthInteger': 1, 'name': [{'family': 'WILLS', 'given': ['Loren', 'T'], 'id': 'hxy1', 'period': {'start': '2012-12-18'}, 'prefix': ['MISS'], 'use': 'usual'}], 'resourceType': 'Patient'}
...
class TestUpdateImmunization(unittest.TestCase):
    ...
    def test_none_existing_imms(self):
        ...
        self.imms_repo.create_immunization.return_value = create_an_immunization_dict(imms_id)
        self.fhir_service.pds_service.get_patient_details.return_value =  {'address': [{'extension': [{'extension': [{'url': 'type', 'valueCoding': {'code': 'PAF', 'system': 'https://fhir.hl7.org.uk/CodeSystem/UKCore-AddressKeyType'}}, {'url': 'value', 'valueString': '19459619'}], 'url': 'https://fhir.hl7.org.uk/StructureDefinition/Extension-UKCore-AddressKey'}], 'id': 'k5f5', 'line': ['GREENACRES', 'WOODCOCK HILL', 'RICKMANSWORTH', 'HERTS'], 'period': {'start': '2012-12-21'}, 'postalCode': 'WD3 1PT', 'use': 'home'}], 'birthDate': '2012-12-18', 'gender': 'female', 'generalPractitioner': [{'id': 'gs8c', 'identifier': {'period': {'start': '2012-12-27'}, 'system': 'https://fhir.nhs.uk/Id/ods-organization-code', 'value': 'E82045'}, 'type': 'Organization'}], 'id': '9990548609', 'identifier': [{'extension': [{'url': 'https://fhir.hl7.org.uk/StructureDefinition/Extension-UKCore-NHSNumberVerificationStatus', 'valueCodeableConcept': {'coding': [{'code': '01', 'display': 'Number present and verified', 'system': 'https://fhir.hl7.org.uk/CodeSystem/UKCore-NHSNumberVerificationStatus', 'version': '1.0.0'}]}}], 'system': 'https://fhir.nhs.uk/Id/nhs-number', 'value': '9990548609'}], 'meta': {'security': [{'code': 'U', 'display': 'unrestricted', 'system': 'http://terminology.hl7.org/CodeSystem/v3-Confidentiality'}], 'versionId': '4'}, 'multipleBirthInteger': 1, 'name': [{'family': 'WILLS', 'given': ['Loren', 'T'], 'id': 'hxy1', 'period': {'start': '2012-12-18'}, 'prefix': ['MISS'], 'use': 'usual'}], 'resourceType': 'Patient'}
