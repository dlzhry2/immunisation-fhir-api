...
class TestFhirControllerAuthorization(unittest.TestCase):
    ...
    def test_update_imms_authorized(self):
        ...
        aws_event = {"headers": {"E-Tag":1,"VaccineTypePermissions":"COVID19:update","AppId":"TestApp"},"pathParameters": {"id": imms_id}, "body": create_covid_19_immunization(imms_id).json()}
