...
class TestUpdateImmunization(unittest.TestCase):
    ...
    def test_update_immunization(self):
        ...
        self.service.update_immunization.assert_called_once_with(imms_id, json.loads(imms),1,"COVID19")
        self.assertEqual(response["statusCode"], 200)
        self.assertTrue("body" not in response)
    ...
    def test_update_deletedat_immunization_with_version(self):
        ...
        self.service.reinstate_immunization.assert_called_once_with(imms_id, json.loads(imms),1,"COVID19")
        self.assertEqual(response["statusCode"], 200)
        self.assertTrue("body" not in response)
